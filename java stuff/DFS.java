...
public class DFS {
    ...
    class Graph {
        ...
        public void DFSUtil(int vertex, boolean[] visited) {
            ...
            Node adjList = array[vertex].head;
            while (adjList != null) {
                int adjVertex = adjList.dest;
                if (!visited[adjVertex]) {
        ...
        public void DFS(int startPoint) {
            boolean[] visited = new boolean[vertex];
            System.out.print("DFS starting from vertex " + startPoint + ": ");
            DFSUtil(startPoint, visited);
            System.out.println();
        }
    }
    ...
    public class BFS {
        public static void main(String[] args) {
            ...
            Graph graph = new Graph(banyakVertex);
            ...
            System.out.print("Masukkan starting node untuk DFS: ");
